# EasyPanel: branch frontend, empty source path, port 3000
# CACHEBUST — change this line to force EasyPanel full rebuild
ARG CACHEBUST=whatsapp-direct-wa-me-v44-2026-08-01
...
# Leave headroom for Next.js trace collection on low-memory EasyPanel builders.
