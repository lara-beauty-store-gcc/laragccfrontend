...
|--------|--------|----------|
| `ChatGPT Image Sep 24, 2026, 07_16_34 PM.png` | **1200×1200** (1:1) | **الصورة الأولى** في معرض أعلى صفحة المنتج |
| `{slug}/hero.webp` | **1200×1200** (1:1) | **الصورة الثانية** في المعرض (أو before/after) |
