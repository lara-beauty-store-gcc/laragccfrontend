export const businessConfig = {
  ...
  checkout: {
    urgencyBanner: 'آخر ٤٨ ساعة على عرض الشحن المجاني',
    socialProof: '+1,200 عميلة طلبت هذا الأسبوع',
    rating: 4.9,
    ratingCount: 312,
    totalLabel: 'الإجمالي',
    codBadge: 'شحن مجاني — الدفع عند الاستلام فقط',
    nameLabel: 'الاسم الكامل',
    namePlaceholder: 'مثال: نورة العتيبي',
    phoneLabel: 'رقم الجوال',
    phonePlaceholder: '0501234567',
    phoneHint: 'يرجى إدخال رقم جوال صحيح لتأكيد التوصيل',
    submitLabel: 'تأكيد الطلب بالدفع عند الاستلام',
    trustNoPay: 'بدون دفع الآن',
    trustCallConfirm: 'نتصل للتأكيد',
    trustRefuseFree: 'ترفضين بدون تكلفة',
