...
export const products: ProductConfig[] = [
  {
    ...
    testimonials: [
      { quote: 'صرت آخذ علكتين بعد العشا — النوم صار أهدأ وأنا مرتاحة أكثر.', name: 'نورة', meta: 'دبي • 34 سنة', initial: 'ن' },
      { quote: 'أحب إنها علكة مو حبوب. الروتين سهل وأنا مستمرة ثلاث أسابيع.', name: 'مريم', meta: 'الشارقة • 41 سنة', initial: 'م' },
      { quote: 'الدفع عند الاستلام خلاني أجرّب بدون قلق — والتوصيل كان سريع.', name: 'هيا', meta: 'دبي • 29 سنة', initial: 'ه' },
    ],
    insightStat: {
      value: '7',
  ...
  },
  {
    ...
    testimonials: [
      { quote: 'صرت آخذها الصبح — أحس يومي أخف وأنشط بدون قهوة زايدة.', name: 'فهد', meta: 'أبوظبي • 38 سنة', initial: 'ف' },
      { quote: 'العلكة طعمها حلو — الروتين سهل وما نسيته.', name: 'سارة', meta: 'دبي • 32 سنة', initial: 'س' },
      { quote: 'طلبت علبتين ووفّرت — التوصيل كان خلال يومين.', name: 'عبدالله', meta: 'أبوظبي • 45 سنة', initial: 'ع' },
    ],
    insightStat: {
      value: '68%',
  ...
  },
  {
    ...
    emotionalPain: 'تفتحين الموبايل وتنسين وش كنتي تسوين — والشغل يتراكم',
    ...
    testimonials: [
      ...
      { quote: 'شغلي يحتاج تركيز — الروتين سهل وما نسيته.', name: 'لمياء', meta: 'الشارقة • 36 سنة', initial: 'ل' },
      { quote: 'طلبت 3 علب ووفّرت — الدفع عند الاستلام مريح.', name: 'شيماء', meta: 'العين • 28 سنة', initial: 'ش' },
    ],
    insightStat: {
      value: '3',
